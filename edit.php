<?php require('database.php');  $id = null; if (!empty($_GET['id'])) { $id = $_REQUEST['id']; } if (null == $id) { header("location:admin.php"); } else {  $pdo = Database ::connect(); $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION) .
...
<br />
<div class="form1"><h1> La fiche de l'etudiant </h1></div>
<p>
